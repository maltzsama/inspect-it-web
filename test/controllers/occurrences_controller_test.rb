...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { description: @occurrence.description, severity: @occurrence.severity, todo: @occurrence.todo } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { description: @occurrence.description, severity: @occurrence.severity, todo: @occurrence.todo } }
