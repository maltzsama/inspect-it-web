...
class RegulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create regulation" do
    assert_difference('Regulation.count') do
      post regulations_url, params: { regulation: { code: @regulation.code, description: @regulation.description, name: @regulation.name } }
    end
  ...
  test "should update regulation" do
    patch regulation_url(@regulation), params: { regulation: { code: @regulation.code, description: @regulation.description, name: @regulation.name } }
